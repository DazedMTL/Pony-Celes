...
(function () {
  Galv.BES.img = PluginManager.parameters("Galv_BasicEventShadows")[
    "Shadow Image"
  ];
  Galv.BES.os = Number(
    PluginManager.parameters("Galv_BasicEventShadows")["Shadow Offset"]
  );
  ...
  Galv.BES.Spriteset_Map_hideCharacters =
  ...
  Galv.BES.Spriteset_Map_createCharacters =
      ...
      if (page) {
        for (var i = 0; i < page.list.length; i++) {
          if (
            ...
            page.list[i].parameters[0].contains("<shadow>")
          ) {
            var shadow = true;
          }
        }
  ...
  Sprite_BasicShadow.prototype.update = function () {
    ...
    this.y =
      this._character.screenY() + this._character.jumpHeight() + Galv.BES.os;
