...
(function () {
  ...
  // パラメータの取得と整形
  //=============================================================================
  var paramPartyCommandName = getParamString([
    "PartyCommandName",
    "パーティコマンド名称",
  ]);
  var paramPartyCommandIndex = getParamNumber([
    "PartyCommandIndex",
    "パーティコマンド位置",
  ]);
  var paramActorCommandName = getParamString([
    "ActorCommandName",
    "アクターコマンド名称",
  ]);
  var paramActorCommandIndex = getParamNumber([
    "ActorCommandIndex",
    "アクターコマンド位置",
  ]);
  ...
  Scene_Battle.prototype.createPartyCommandWindow = function () {
    ...
    if (paramPartyCommandName) {
      this._partyCommandWindow.setHandler(
        "auto",
        this.commandPartyAutoBattle.bind(this)
      );
    }
  };
  ...
  Scene_Battle.prototype.createActorCommandWindow = function () {
    ...
    if (paramActorCommandName) {
      this._actorCommandWindow.setHandler(
        "auto",
        this.commandActorAutoBattle.bind(this)
      );
    }
  };
