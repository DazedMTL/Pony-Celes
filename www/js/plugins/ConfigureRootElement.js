...
(function () {
  ...
  try {
    if (RootElementId) {
      ...
      !(
        PluginManager.parameters(GAME_ROOT_ELEMENT_NODE_KEY) instanceof
        HTMLElement
      )
    ) {
      PluginManager.setParameters(GAME_ROOT_ELEMENT_NODE_KEY, document.body);
  ...
  Graphics._createErrorPrinter = function () {
    ...
    PluginManager.parameters(GAME_ROOT_ELEMENT_NODE_KEY).appendChild(
      this._errorPrinter
    );
  };
  ...
  Graphics._disableContextMenu = function () {
    var elements = PluginManager.parameters(
      GAME_ROOT_ELEMENT_NODE_KEY
