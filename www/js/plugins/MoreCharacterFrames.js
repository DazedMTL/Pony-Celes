...
(function () {
  ...
  Game_CharacterBase.prototype.pattern = function () {
    if (!this._isMultiFrame) {
      ...
      return this._pattern < this._frames[this._direction / 2 - 1]
        ? this._pattern
        : 0;
    }
  };

  var _Game_CharacterBase_isOriginalPattern =
  ...
  var _Game_CharacterBase_resetPattern =
  ...
  var _Game_CharacterBase_setTileImage =
