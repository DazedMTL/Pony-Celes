 ...
 */
/*:ja
 * @plugindesc v1.00 FPSシンク機能をオン・オフにできるオプションを追加。
 * @author Liquidize
 *
 * @param Command Name
 * @desc オプション内のコマンド名
 ...
 * ============================================================================
 *
 * RPG Maker MV　1.2.0以降で使用可能
 *
 * v1.1.0.　で追加されました、FPSシンク機能をオン・オフできるオプションの追加。
 *
 */
//=============================================================================
...
Liquidize.Param.FpsSyncDefault = eval(
  String(Liquidize.Parameters["Default Value"])
);
