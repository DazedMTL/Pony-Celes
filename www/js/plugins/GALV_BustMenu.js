...
(function () {
  ...
  Galv.BM.ar = Number(
    PluginManager.parameters("Galv_BustMenu")["Menu Actor Rows"]
  );
  Galv.BM.name = Number(PluginManager.parameters("Galv_BustMenu")["Name"] - 1);
  Galv.BM.nickname = Number(
    PluginManager.parameters("Galv_BustMenu")["Nickname"] - 1
  );
  Galv.BM.class = Number(
    PluginManager.parameters("Galv_BustMenu")["Class"] - 1
  );
  Galv.BM.level = Number(
    PluginManager.parameters("Galv_BustMenu")["Level"] - 1
  );
  ...
  Galv.BM.xpBar =
    PluginManager.parameters("Galv_BustMenu")["Show Exp Bar"] == "true"
      ? true
      : false;
  Galv.BM.xpText =
    PluginManager.parameters("Galv_BustMenu")["Show Exp Text"] == "true"
      ? true
      : false;
  Galv.BM.xpLabel = PluginManager.parameters("Galv_BustMenu")["Exp Text"];
  Galv.BM.xpHeight =
    PluginManager.parameters("Galv_BustMenu")["Exp Bar Height"];
  Galv.BM.maxTxt = PluginManager.parameters("Galv_BustMenu")["Max Exp Text"];

  Galv.BM.xpCol1 = Number(
    PluginManager.parameters("Galv_BustMenu")["Exp Bar Color 1"]
  );
  Galv.BM.xpCol2 = Number(
    PluginManager.parameters("Galv_BustMenu")["Exp Bar Color 2"]
  );
  Galv.BM.icons = Number(
    PluginManager.parameters("Galv_BustMenu")["States"] - 1
  );
  Galv.BM.bust = Number(PluginManager.parameters("Galv_BustMenu")["Bust Y"]);
  Galv.BM.bustHeight = Number(
    PluginManager.parameters("Galv_BustMenu")["Bust Height"]
  );
  Galv.BM.offsets = (function () {
    var array =
      PluginManager.parameters("Galv_BustMenu")["Bust Offsets"].split("|");
    var obj = {};
  ...
  if (
    PluginManager.parameters("PrettyGauges") &&
    Object.keys(PluginManager.parameters("PrettyGauges")).length > 0
  ) {
  ...
  Window_MenuStatus.prototype.maxCols = function () {
    return $gameParty._bustActorCount;
  };
  ...
  Window_MenuStatus.prototype.drawActorSimpleStatus = function (
    ...
    if (Galv.BM.xp > -1)
      this.drawActorEXP(actor, x, y + lineHeight * Galv.BM.xp, width2);
    if (Galv.BM.name > -1)
      this.drawActorName(actor, x, y + lineHeight * Galv.BM.name);
    if (Galv.BM.nickname > -1)
      this.drawActorNickname(actor, x, y + lineHeight * Galv.BM.nickname);
    if (Galv.BM.level > -1)
  ...
  Game_Actor.prototype.xpRate = function () {
    return (
      (this.nextLevelExp() - this.currentExp()) /
      (this.nextLevelExp() - this.currentLevelExp())
    );
  };
  ...
  if (Galv.BM.rmplugin) {
    ...
    Window_Base.prototype.drawExpGauge = function (
      x,
      y,
      width,
      rate,
      ...
      this.contents.fillTrap(
        x,
        gaugeY,
        width,
        width,
        barHeight,
        this.gaugeBackColor1(),
        this.gaugeBackColor2()
      );
      this.contents.fillTrap(
        x,
        gaugeY,
  ...
  Bitmap.prototype.unlimitedBlt = function (
    source,
    sx,
    sy,
    sw,
  ...
  Window_MenuStatus.prototype.bustWidth = function () {
    return Math.floor(
      (this.width - this.standardPadding() * 2) / this.maxCols()
    );
  };
