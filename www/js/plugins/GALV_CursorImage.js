...
(function () {
  Galv.CI.initHidden =
    PluginManager.parameters("Galv_CursorImage")[
      "Start Hidden"
    ].toLowerCase() === "true"
      ? true
      : false;
  ...
  Galv.CI.frames = Number(
    PluginManager.parameters("Galv_CursorImage")["Image Frames"]
  );
  Galv.CI.animSpeed = Number(
    PluginManager.parameters("Galv_CursorImage")["Animation Speed"]
  );
  Galv.CI.center =
    PluginManager.parameters("Galv_CursorImage")[
      "Position Centered"
      ...
      ? true
      : false;
  Galv.CI.cIndent = Number(
    PluginManager.parameters("Galv_CursorImage")["Command Indent"]
  );
  Galv.CI.iIndent = Number(
    PluginManager.parameters("Galv_CursorImage")["Item Indent"]
  );
  var tmp =
    PluginManager.parameters("Galv_CursorImage")["Position Offset"].split(",");
  ...
  Galv.CI.Window_BattleStatus_drawActorName =
    Window_BattleStatus.prototype.drawActorName;
  ...
  Window_BattleActor.prototype.createGalvCursor =
  ...
  Galv.CI.Window_Selectable_drawItemName =
    Window_Selectable.prototype.drawItemName;
