...
(function () {
  ...
  TDDP_ManageDashing.disableAutoDash = Boolean(
    parameters["Disable Auto-dash"] === "true" || false
  );
  TDDP_ManageDashing.disableDashing = Boolean(
    parameters["Disable Dashing"] === "true" || false
  );
  TDDP_ManageDashing.removeDashOption = Boolean(
    parameters["Remove Dash Option"] === "true" || false
  );
  /**
  ...
  Window_Options.prototype.addGeneralOptions = function () {
    if (TDDP_ManageDashing.showDashOption())
