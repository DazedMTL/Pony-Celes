...
for (var i = 0; i < Moghunter.tparticles_M; i++) {
  ...
  Moghunter.tparticles_Z[i] = Number(
    Moghunter.parameters["P" + String(i + 1) + " Z Index"] || 20
  );
...
Scene_Title.prototype.create = function () {
  ...
  if (this._titleField) {
    this._titleField.children.sort(function (a, b) {
...
// * Create Background
//==============================
var _mog_title_particles_createBackground =
...
// * Create Background
//==============================
var _mog_titleparticles_createForeground =
...
TitleParticles.prototype.lx2 = function (sprite) {
  if (sprite.sx[1] > 0) {
    ...
    return Graphics.boxWidth + Graphics.boxWidth / 2;
  }
};
