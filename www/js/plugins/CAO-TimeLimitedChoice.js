...
!(function () {
  ...
  const pluginCommands = {
    skip: function (args) {
      $gameMessage.setChoiceTimeoutType(99);
    },
    select: function (args) {
      $gameMessage.setChoiceTimeoutType(-1);
    },
    cancel: function (args) {
      $gameMessage.setChoiceTimeoutType(-2);
    },
    index: function (args) {
      $gameMessage.setChoiceTimeoutType(args.index - 1);
    },
  };
  ...
  const _Game_Interpreter_setupChoices =
  ...
  Window_ChoiceList.prototype.close = function () {
    ...
    if (pluginParams.TimeleftVariableID) {
      $gameVariables.setValue(
        pluginParams.TimeleftVariableID,
        pluginParams.TimeleftType === "秒数"
          ? $gameTimer.seconds()
          : $gameTimer._frames
      );
    }
