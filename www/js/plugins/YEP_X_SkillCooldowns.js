...
if (Imported.YEP_SkillCore) {
  ...
  Yanfly.Param.CDAfterBattle = String(
    Yanfly.Parameters["Cooldown After Battle"]
  );
  ...
  if (Imported.YEP_BattleEngineCore) {
    ...
    BattleManager.processActionSequence = function (actionName, actionArgs) {
      ...
      return Yanfly.SCD.BattleManager_processActionSequence.call(
        this,
        actionName,
        actionArgs
      );
  ...
  Yanfly.SCD.Window_SkillList_drawCost =
