...
(function () {
  ...
  Utils.processParameters = function () {
    ...
    result["HP Price"] = Number(parameters["HP Price"] || 0);
    result["MP Price"] = Number(parameters["MP Price"] || 0);
    result["State Price"] = Number(parameters["State Price"] || 0);

    result["Nurse Face"] = [nurseFace[0], Number(nurseFace[1])];
    result["Nurse Name"] = String(parameters["Nurse Name"] || "Nurse");
    result["Nurse Message"] = String(parameters["Nurse Message"] || "Hello!");

    result["Heal One Help"] = String(parameters["Heal One Help"] || "");
    ...
    result["Exit Help"] = String(parameters["Exit Help"] || "");

    result["Actor Help (Treat)"] = String(
      parameters["Actor Help (Treat)"] || ""
    );
    result["Actor Help (Healthy)"] = String(
      parameters["Actor Help (Healthy)"] || ""
    );

    result["Heal One Command"] = String(
      parameters["Heal One Command"] || "Heal One"
    );
    result["Heal All Command"] = String(
      parameters["Heal All Command"] || "Heal All"
    );
    result["Exit Command"] = String(parameters["Exit Command"] || "Exit");

    result["Text Alignment"] = String(parameters["Text Alignment"] || "center");
...
(function () {
   ...
   */
  HospitalActors.prototype = Object.create(Window_Selectable.prototype);
...
(function () {
  ...
  Hospital.prototype._createCommandWindow = function () {
    ...
    this._commandWindow.setHandler("healOne", this._commandHealOne.bind(this));
    this._commandWindow.setHandler("healAll", this._commandHealAll.bind(this));
